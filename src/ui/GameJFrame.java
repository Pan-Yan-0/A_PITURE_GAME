...
public class GameJFrame extends JFrame implements KeyListener, MouseListener {
    ...
    public void mouseReleased(MouseEvent e) {
        ...
        if (source == replayItem) {
            ...
            System.out.println("打赏我们");
            //创建一个弹框对象
            JDialog jDialog = new JDialog();
            //创建以哦个管理图片的容器对象JLabal
            JLabel jLabel = new JLabel(new ImageIcon("src/image/qrcode_1686456316142.jpg"));
            //设置位置和宽高
            jLabel.setBounds(0, 0, 350, 350);
            //把图片添加到弹框中
            jDialog.getContentPane().add(jLabel);
            //给弹框去设置大小
            jDialog.setSize(540, 540);
            //让弹框置顶设置
            ...
            path = ("src\\image\\sport\\sport" + num + "\\");
            this.getContentPane().removeAll();
            count = 0;
            initData();
            initImage();
